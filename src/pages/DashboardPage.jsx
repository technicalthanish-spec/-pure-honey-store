...
export default function DashboardPage(){
 ...
 return <div className="admin-page finance-dashboard">
  <div className="page-header"><div><span className="eyebrow">BUSINESS OVERVIEW</span><h1>Dashboard</h1><p>Stock, sales, collections, free giveaways and estimated profit in one place.</p></div><div className="report-actions"><Link className="primary-btn" to="/admin/new-sale">+ New sale</Link><Link className="secondary-btn" to="/admin/customers">Customer khata</Link></div></div>
