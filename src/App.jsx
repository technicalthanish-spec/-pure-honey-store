...
<Route element={<ProtectedAdmin/>}><Route path="/admin" element={<AdminLayout/>}><Route index element={<DashboardPage/>}/><Route path="sales-report" element={<Suspense fallback={<p>Loading sales report…</p>}><SalesReportPage/></Suspense>}/><Route path="orders" element={<OrdersPage/>}/><Route path="orders/:orderId" element={<OrderDetailPage/>}/><Route path="products" element={<ProductsPage/>}/><Route path="coupons" element={<CouponsPage/>}/><Route path="invoices/:invoiceId" element={<Suspense fallback={<p>Loading invoice…</p>}><InvoiceDetailPage/></Suspense>}/></Route></Route>
